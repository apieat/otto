...
func TestFunction_stack(t *testing.T) {
	tt(t, func() {
		...
		expected := []frame{
			{native: true, nativeFile: "function_stack_test.go", nativeLine: 36, offset: 0, callee: "github.com/apieat/otto.TestFunction_stack.func1.2"},
			{native: true, nativeFile: "function_stack_test.go", nativeLine: 29, offset: 0, callee: "github.com/apieat/otto.TestFunction_stack.func1.1"},
